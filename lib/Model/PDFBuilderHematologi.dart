...
Future<void> generatePDFHematologi(
    //Data Pribadi
    String Nama,
    String NRP,
    String NIP,
  ...
  MainSize != 100 ? MainSize=100 : MainSize;
  ...
  document.dispose();
  //Launch file.
  await saveAndLaunchFile(bytes, "Hematologi_"+Nama+'.pdf');
}
...
PdfLayoutResult _drawHeader(
  ...
  page.graphics.drawString("Nama Pemeriksaan",
      ...
      bounds: Rect.fromLTWH(0+5,MainSize+80, pageSize.width/3, 60),
      brush: PdfBrushes.black,
      format: PdfStringFormat(
  ...
  page.graphics.drawString(
      "Nilai Rujukan",
      PdfStandardFont(PdfFontFamily.helvetica, 10),
      bounds: Rect.fromLTWH(pageSize.width*(2/3),MainSize+80, pageSize.width/3-5, 60),
      brush: PdfBrushes.black,
      format: PdfStringFormat(
...
void _drawGridHematologi(PdfPage page,String Hemogoblin,String Hematokrit,String Lekosit,String Trombosit,String Eritrosit,String LED) {
  ...
  //-------------------------------------------------------
  //HEMATOLGI
  print("Zyarga Debugger ada ? : "+Hemogoblin);
  ListData.clear();
