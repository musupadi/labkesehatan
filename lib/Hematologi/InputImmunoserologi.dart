...
import 'package:labkesehatanehatan/Model/PDFBuilderImmunoserologi.dart';
...
class InputImmunoserologi extends StatefulWidget {
  const InputImmunoserologi({Key? key}) : super(key: key);

  @override
  State<InputImmunoserologi> createState() => _InputImmunoserologiState();
}

class _InputImmunoserologiState extends State<InputImmunoserologi> {
